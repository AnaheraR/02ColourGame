...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        help_text = "Your goal in this game is to beat the computer and " \
                    "you have an advantage - you get to choose your colour first.  " \
                    "The points associated with the colours are based on the colours hex code.  " \
                    "The higher the value of the colour, the greater your score. \n\n" \
                    "To see your statistics, click on the 'Statistics' button.  Win the " \
                    "game by scoring more than the computer overall.  Don't be discouraged " \
                    "if you don't win every round, its your overall score that counts. \n\n " \
